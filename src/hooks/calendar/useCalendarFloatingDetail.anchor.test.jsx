...
import CalendarCell from "../../components/calendar/modal/CalendarCell.jsx";
import { dateCellSelector } from "./calendarFloatingDetailModel.js";
...
const hookHolder = { current: null };

function cellProps(day, dateKey) {
  return {
    view: "events",
    viewYear: 2026,
    viewMonth: 3,
