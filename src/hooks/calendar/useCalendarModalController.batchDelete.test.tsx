...
interface QuickActionArgs { onBatchDeleted: (events: FloatingEditorItem[]) => void }
let latestShellProps = {} as ShellProps;
const quickActions = vi.hoisted<{ args: QuickActionArgs | null }>(() => ({ args: null }));
...
vi.mock("../../components/calendar/events/useCalendarQuickActions", () => ({
  default: vi.fn((args: QuickActionArgs) => {
...
function selectableEvent(overrides: Partial<FloatingEditorItem> = {}) {
  return {
    id: "event-1",
    title: "Standup",
