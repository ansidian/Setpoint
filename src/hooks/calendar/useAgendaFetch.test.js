...
import { useAgendaFetch } from "./useAgendaFetch.js";

function mockDomainRange() {
  return {
...
describe("useAgendaFetch", () => {
  ...
  it("triggers fetch when topmost month approaches the end boundary", async () => {
    ...
    const { result, rerender } = renderHook(
      ...
      { initialProps: { topmostMonth: null } },
    );
  ...
  describe("pendingTargetMonth", () => {
    function setupLoaded() {
      ...
      const hook = renderHook(
        ({ topmostMonth, pendingTargetMonth }) =>
          useAgendaFetch({
            topmostMonth,
            pendingTargetMonth,
            domainRange,
        ...
        { initialProps: { topmostMonth: null, pendingTargetMonth: null } },
      );
