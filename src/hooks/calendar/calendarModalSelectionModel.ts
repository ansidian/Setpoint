import { pacificTodayParts, ymdFromParts } from "../../components/calendar/calendarDateUtils.ts";
...
export interface CalendarModalSyncInput {
  open: boolean;
  view: string;
  prevOpen: boolean;
  prevView: string;
  prevOpenRequestId: number;
...
export interface CalendarModalSyncSnapshot {
  didViewChange: boolean;
  resetDeadlineEditor: boolean;
  nextViewDate: CalendarViewDate;
  nextSelectedDay: number | null;
  nextSelectedDateKey: string | null;
  nextSelectedItemId: string | null;
  nextPendingFocusDate: string | null;
  nextPendingFocusItemId: string | null;
  openCreate: boolean;
}

export function parseFocusDate(focusDate: string | null | undefined): Date | null {
...
export function resolveFocusViewDate(focus: Date | null, currentViewDate: CalendarViewDate): CalendarViewDate {
...
export function buildCalendarModalSyncSnapshot({
  ...
  pendingFocusDate,
  pendingFocusItemId,
}: CalendarModalSyncInput): CalendarModalSyncSnapshot | null {
