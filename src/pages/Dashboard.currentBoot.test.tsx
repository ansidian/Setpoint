...
interface DomainRangeOptions { cacheMode?: string }
interface CurrentBootShellProps {
  bd: { briefing?: { calendar?: unknown[] } | null };
  liveData: { liveWeather?: { temp?: number } | null; liveBills?: unknown[] };
  activeSnapshot?: { snapshot?: { snapshot?: { id?: number } } };
}
...
vi.mock("../hooks/calendar/useCalendarDomainRange", () => ({
  default: (options: DomainRangeOptions = {}) => {
...
vi.mock("../components/dashboard/DashboardShell", () => ({
  DashboardShell: ({ bd, liveData, activeSnapshot }: CurrentBootShellProps) => (
