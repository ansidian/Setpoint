...
import { resolveActualActionStatusView } from "./actualActionStatusModel.js";
...
export default function ActualActionStatus({ resolution, style }) {
  const view = resolveActualActionStatusView(resolution);
  if (!view) return null;

  const tone = TONES[view.tone] || TONES.unavailable;
