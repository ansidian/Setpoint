...
import { ChevronDown, Download, File, FileImage, FileSpreadsheet, FileText, Paperclip } from "lucide-react";
...
export default function EmailAttachmentShelf({
  ...
  return (
    ...
    >
      {isMobile ? (
        <button type="button" className="mobile-reader-disclosure" aria-expanded={expanded} onClick={() => setExpanded((value) => !value)}>
      ...
      <AnimatedCollapse open={!isMobile || expanded}>
