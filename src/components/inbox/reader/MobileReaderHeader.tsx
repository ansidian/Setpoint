...
import { InlineControlButton, MobileStatusPill } from "./MobileReaderControls";
...
export default function MobileReaderHeader({
  ...
  accent: string;
  actionsBtnRef: RefObject<HTMLButtonElement | null>;
  actionsActive: boolean;
  onToggleActions: MouseEventHandler<HTMLButtonElement>;
