...
import MobileTriageBar from "./MobileTriageBar.jsx";
...
describe("MobileTriageBar", () => {
  ...
  it("disables snapshot triage verbs while a snapshot mutation is pending", () => {
    ...
    expect(screen.getByRole("button", { name: "Handled" }).disabled).toBe(true);
    expect(screen.getByRole("button", { name: "FYI" }).disabled).toBe(true);
    expect(screen.getByRole("button", { name: "Noise" }).disabled).toBe(true);
    expect(screen.getByRole("button", { name: "Snooze" }).disabled).toBe(false);
  });
