...
export function formatInboxCategoryLabel(category) {
  return String(category || "")
    .replace(/_/g, " ")
    .replace(/\b\w/g, (match) => match.toUpperCase());
}

export function sortInboxCategoryFilters(categories = []) {
...
export function partitionInboxCategoryFilters(categories = [], {
