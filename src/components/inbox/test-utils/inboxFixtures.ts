...
import type { InboxActiveSnapshotLike } from "../inboxWorkItems";

export interface InboxEmailFixture extends InboxEmailLike {
  id: string;
  uid: string;
  subject: string;
  from: string;
...
export function makeInboxEmail(overrides: Partial<InboxEmailFixture> = {}): InboxEmailFixture {
...
export function makeInboxAccounts(): InboxAccount[] {
  return [
    {
      id: "acc-work",
      name: "Work",
...
export function makeLiveInboxEmail(overrides: Partial<InboxEmailLike> = {}): InboxEmailLike {
  const uid = typeof overrides.uid === "string" ? overrides.uid : "live-1";
  return {
    uid,
...
export function makeActiveSnapshot(overrides: Partial<InboxActiveSnapshotLike> = {}): InboxActiveSnapshotLike {
  return {
