...
const NOTE: Note = { id: 1, user_id: "test", content: "buy milk and eggs", sort_order: 0, created_at: "2026-06-18 10:00:00", archived_at: null };
...
describe("NoteItem inline edit", () => {
  ...
  it("surfaces #tags as footer chips and strips them from the body text", () => {
    renderItem({ note: { id: 2, user_id: "test", content: "Renew the domain #admin", sort_order: 0, created_at: "2026-06-18 10:00:00" } });
  ...
  it("shows an 'edited' label when updated_at is well after created_at", () => {
    renderItem({ note: { id: 3, user_id: "test", content: "tweaked note", sort_order: 0, created_at: "2026-06-01 10:00:00", updated_at: "2026-06-18T10:00:00.000Z" } });
    expect(screen.getByText(/edited/i)).toBeTruthy();
  });

  it("shows no 'edited' label for a freshly created note", () => {
    renderItem({ note: { id: 4, user_id: "test", content: "brand new", sort_order: 0, created_at: "2026-06-18 10:00:00", updated_at: "2026-06-18T10:00:20.000Z" } });
