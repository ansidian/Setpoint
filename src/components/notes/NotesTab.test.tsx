...
interface FakeAddTaskPanelProps { onTaskAdded: (task: { id: number }) => void }
interface FakeNoteEditorProps { placeholder?: string; value?: string; onChange?: (value: string) => void }
...
vi.mock("./NoteEditor", () => ({
  default: (props: FakeNoteEditorProps) => (
    <textarea
