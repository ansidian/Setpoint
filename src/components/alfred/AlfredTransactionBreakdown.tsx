...
import { spendingBreakdownRows, formatAlfredMoney } from "./alfredPanelModel";
...
const GROUP_LABELS: Record<TransactionGroupBy, string> = { category: "BY CATEGORY", payee: "BY PAYEE", month: "BY MONTH" };
