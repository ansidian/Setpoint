...
import { googleSpecialDateAccent } from "./googleSpecialDateModel.ts";
...
export default function GoogleSpecialDateBadge({
  ...
  active = false,
  variant = "chip",
}: { item?: Parameters<typeof googleSpecialDateAccent>[0]; color?: string; selected?: boolean; active?: boolean; variant?: keyof typeof SIZE_BY_VARIANT }) {
