...
const AgendaMonthScrollContainer = forwardRef(function AgendaMonthScrollContainer({
  ...
  const registerRow = useCallback((key, node, dateKey) => {
  ...
  const registrationCallbacks = { registerHeader, registerSection, registerRow, registerContent };
