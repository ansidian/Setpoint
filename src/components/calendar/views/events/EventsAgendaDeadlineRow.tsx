...
import type { AgendaDeadline } from "./eventsAgendaModel";

function AgendaDeadlineStatus({ deadline }: { deadline: AgendaDeadline }) {
...
export default function EventsAgendaDeadlineRow({
  ...
  onSelect: (deadline: AgendaDeadline, anchor: HTMLElement) => void;
  onPreviewStart?: (deadline: AgendaDeadline) => void;
  onPreviewEnd?: (deadline: AgendaDeadline) => void;
}) {
