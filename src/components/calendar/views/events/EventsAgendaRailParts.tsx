...
import type { CalendarWeatherDay } from "../calendarViewTypes";
...
export function WeatherHeader({ weather: weatherInput }: { weather?: unknown }) {
  const weather = weatherInput as CalendarWeatherDay | null | undefined;
