...
interface EventsHeaderEditor {
  editable?: boolean;
  openCreate?: () => void;
  eventOverlay?: VisibilityOverlay | null;
  deadlineOverlay?: VisibilityOverlay | null;
}

export default function EventsHeaderExtras({ editor, selectedDateLabel }: { editor: EventsHeaderEditor; selectedDateLabel?: string | null }) {
  ...
  const toggleStyle = (active: boolean, key: string, disabled = false): CSSProperties => ({
    display: "inline-flex",
    alignItems: "center",
