...
import { relativeDateLabel } from "./billsModel.ts";
import type { BillsViewData } from "./billsModel";
import { deriveUtilityDateText, deriveUtilityStatus } from "./utilityStatusModel.ts";
...
export default function UtilityStatusButton({ data }: { data?: BillsViewData | null }) {
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {utilityStatus.map((utility) => {
              const Icon = ICONS[utility.key] || Zap;
