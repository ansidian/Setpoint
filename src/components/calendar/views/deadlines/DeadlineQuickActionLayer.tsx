...
import { clampMenuPosition } from "../../events/quickActionMenuLayout";
import type { CSSProperties, PointerEvent as ReactPointerEvent } from "react";
import type { DeadlineMenuItem, DeadlineQuickActions } from "./useDeadlineQuickActions";

function stop(event: ReactPointerEvent): void {
  event.stopPropagation();
}

function actionButtonColors(tone: string | undefined, active: boolean): CSSProperties {
  if (tone === "danger") {
    return {
...
function MenuButton({ item, disabled, onSelect }: {
  item: Exclude<DeadlineMenuItem, { type: "separator" }>;
  disabled?: boolean;
  onSelect?: () => void;
}) {
...
function ContextMenu({ quickActions }: { quickActions: DeadlineQuickActions }) {
...
function Status({ quickActions }: { quickActions: DeadlineQuickActions }) {
...
export default function DeadlineQuickActionLayer({ quickActions }: { quickActions?: DeadlineQuickActions | null }) {
