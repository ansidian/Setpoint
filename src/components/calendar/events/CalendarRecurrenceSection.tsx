...
interface RecurrenceUntilDatePickerProps {
  value: string;
  startDate: string;
  disabled: boolean;
  onChange: (value: string) => void;
...
interface CalendarRecurrenceSectionProps {
...
function RecurrenceUntilDatePicker({ value, startDate, disabled, onChange, testId }: RecurrenceUntilDatePickerProps) {
  const [open, setOpen] = useState(false);
