...
import { Calendar as CalendarIcon, Clock3, Layers3, MapPin, Repeat, type LucideIcon } from "lucide-react";
...
interface CalendarEventCompactCorrectionToolbarProps {
  ...
  onExitBatchMode: CalendarEventEditorController["exitBatchMode"];
...
function scheduleLabel(draft: CalendarEventDraft) {
...
}: CalendarEventCompactCorrectionToolbarProps) {
