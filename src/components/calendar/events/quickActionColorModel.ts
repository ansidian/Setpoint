...
interface EventColorSelection {
  colorId?: string | number | null;
  sourceColorId?: string | number | null;
  color?: string | null;
...
export function selectedEventColorId(
  event: EventColorSelection | null | undefined,
) {
...
export function checkColorForDot(hex: string) {
