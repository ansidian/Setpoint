...
interface CalendarRecurringScopePromptProps {
  selectedScope: CalendarRecurrenceScope | null;
  disabled?: boolean;
  onSelectScope: (scope: CalendarRecurrenceScope) => void;
}
...
export default function CalendarRecurringScopePrompt({
  ...
  disabled = false,
  onSelectScope,
}: CalendarRecurringScopePromptProps) {
  return (
    <div
