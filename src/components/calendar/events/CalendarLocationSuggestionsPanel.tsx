...
interface CalendarLocationSuggestionsPanelProps {
  suggestions: CalendarPlaceSuggestion[];
  loading?: boolean;
  error?: string | null;
  activeIndex?: number;
  onSelect: (suggestion: CalendarPlaceSuggestion) => void | Promise<unknown>;
}
...
export default function CalendarLocationSuggestionsPanel({
  ...
  activeIndex = 0,
  onSelect,
}: CalendarLocationSuggestionsPanelProps) {
