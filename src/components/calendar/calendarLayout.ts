...
export type CalendarLayoutMetrics = (typeof LAYOUT_METRICS)[keyof typeof LAYOUT_METRICS];

export function getCalendarLayoutMetrics(viewportWidth: number): CalendarLayoutMetrics {
...
export function getCalendarSearchLayoutMode(layout: Pick<CalendarLayoutMetrics, "stacked" | "tier">, searchOpen = false): string {
