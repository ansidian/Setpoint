...
import {
  ...
  SearchResultRow,
  SearchSkeleton,
} from "./CalendarSearchRailParts.jsx";
...
function weatherByDate(weatherData, todayKey = calendarSearchTodayKey()) {
  const map = new Map();
...
function resultGroupCenterDateKey(groups, todayKey = calendarSearchTodayKey()) {
