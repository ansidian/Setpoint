...
export interface CalendarFloatingDetailCaretProps {
  caretSide?: "left" | "right" | null;
  caretTop: number;
}

export default function CalendarFloatingDetailCaret({ caretSide, caretTop }: CalendarFloatingDetailCaretProps) {
