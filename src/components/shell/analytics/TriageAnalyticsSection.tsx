...
import { Metric, TierRow } from "./analyticsPrimitives";
import { formatUsdEstimate, formatCompactNumber, numberValue } from "./analyticsFormat";
import type { TriageCacheStatsResponse } from "../../../../shared/types/settings";

export default function TriageAnalyticsSection({ stats }: { stats: TriageCacheStatsResponse }) {
