...
export function ChipEditor({ label, chips, placeholder, onChange }) {
...
export function MappingSelect({ label, value, options, onChange }) {
  return (
    <div className="min-w-0">
      <SectionLabel>{label}</SectionLabel>
      <select
...
export function ReorderButtons({ label, index, count, onMove }) {
  return (
