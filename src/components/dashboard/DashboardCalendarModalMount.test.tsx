...
vi.mock("../calendar/CalendarModal", () => ({
  default: function CalendarModalMock({ deadlinesData, billsData }: {
    deadlinesData?: { upcoming?: Array<{ title?: string }> };
    billsData?: { schedules?: Array<{ id?: string; scheduleId?: string; paid?: boolean }> };
  }) {
    return (
      <div
...
const { default: DashboardCalendarModalMount } = await import("./DashboardCalendarModalMount");
