...
import { deriveTimelineRowState } from "./timeline-helpers";
import type { TimelineRowItem } from "./TimelineRow";
...
function timelineRowProps(item: TimelineRowItem, now: number, { isMobile }: { isMobile?: boolean } = {}) {
