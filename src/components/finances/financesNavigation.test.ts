...
it('round-trips exact utility, occurrence and transaction targets and rejects invalid dates',()=>{
  const targets:FinanceDestination[]=[{view:'utilities',utilityId:'water',month:'2026-07',statementId:'email:1'},{view:'schedule',scheduleId:'schedule',date:'2026-07-14'},{view:'journal',date:'2026-08-03',transactionId:'cross-date'}];
