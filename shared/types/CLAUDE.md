...
- `financial-connections.ts` — canonical provider/account configuration, utility identity, payment link and revisioned save contracts
- `financial-parsers.ts` — browser-safe company catalog, source input, and deterministic parsed/review/nonfinancial assessment contracts
