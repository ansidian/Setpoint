...
const DEFINITIONS = [
  { key: "ai.anthropic_api_key", handling: "secret", envAliases: ["ANTHROPIC_API_KEY"], validatorOwner: "ai", capabilities: ["ai"] },
  { key: "ai.openai_api_key", handling: "secret", envAliases: ["OPENAI_API_KEY"], validatorOwner: "ai", capabilities: ["ai"] },
