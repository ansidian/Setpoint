...
import { buildStartupWorkerDelays, calculateStartupDelayMs } from "./startup-delays.ts";
...
describe("startup worker delays", () => {
  ...
  it("allows per-worker startup offset overrides", () => {
    const delays = buildStartupWorkerDelays({
      ...
      EA_STARTUP_CALENDAR_SEARCH_MIRROR_OFFSET_MS: "5500",
      EA_STARTUP_REMINDERS_OFFSET_MS: "6000",
    }, () => 0);
