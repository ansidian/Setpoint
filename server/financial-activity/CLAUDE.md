...
- `financial-activity.ts` — one consistent owner snapshot, semantic filtering and pagination, exact occurrence lookup, and immutable receipt and latest correction projection
