...
- `paypal.ts` — Synchrony card statements/autopay/refunds, merchant receipts/refunds/authorizations, balance transfers and received-money notices
...
- Company modules own template matching and label semantics. Shared helpers do not choose a company's operational amount or infer accounting destinations.
