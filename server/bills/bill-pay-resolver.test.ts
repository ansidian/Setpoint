    ...
    const result = resolveBillPayMapping({
      mappings: {
        ...
        profiles: [{
          id: "chase",
          enabled: true,
          identity: { domain: ["chase.com"], last4: ["0002"] },
          behaviors: [{
            id: "minimum",
            enabled: true,
            type: "transfer",
      ...
      email: {
        ...
        body: "Account Chase Credit Card (...0002) Due date 03/28/2026 Minimum payment due $40.00 Statement balance $54.41 Auto-pay enabled",
      },
    });
