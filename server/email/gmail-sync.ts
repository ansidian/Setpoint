...
export { registerGmailWatch, renewDueGmailWatches } from "./gmail-watch-lifecycle.ts";
...
export async function syncGmailHistoryForAccount(account: GmailSyncAccount, {
  ...
  requestFinancialDrainFn = requestTransactionImportDrain,
}: {
  ...
  requestFinancialDrainFn?: () => unknown;
