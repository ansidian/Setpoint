...
import { mergeCandidates, retrieveInboxAiSearch } from "./email-search-retrieval.ts";
...
describe("mergeCandidates coverage-aware fusion", () => {
  const lex = (uid: string, search_score: number, extra: Partial<EmailSearchRankingRow> = {}): EmailSearchRankingRow & { uid: string; search_score: number } => ({
    subject: uid,
    email_date: "2026-06-13T12:00:00Z",
    ...extra,
    uid,
  ...
  const vrow = (uid: string, extra: Partial<EmailSearchRankingRow> = {}): EmailSearchRankingRow & { uid: string } => ({
    subject: uid,
    email_date: "2026-01-01T12:00:00Z",
    ...extra,
    uid,
...
describe("candidate pool recency", () => {
  ...
  it("breaks combined-score ties by recency instead of uid order", () => {
    const row = (uid: string, date: string): EmailSearchRankingRow & { uid: string; search_score: number } => ({
      uid,
      subject: "statement",
