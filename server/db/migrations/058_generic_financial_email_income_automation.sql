ALTER TABLE ea_transaction_import_items RENAME TO ea_transaction_import_items_before_income_automation;
...
SELECT
  ...
  dismissed_at, created_at, updated_at, email_subject,
  financial_email_plan_json, financial_plan_shadow_json
FROM ea_transaction_import_items_before_income_automation;

DROP TABLE ea_transaction_import_items_before_income_automation;
