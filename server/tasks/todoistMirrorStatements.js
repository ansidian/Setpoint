...
export function fullSyncTombstoneStatements(userId, timestamp) {
  return [
    {
...
export function completedOccurrenceReconcileStatement(userId) {
  return {
...
export function itemStatement(userId, item, timestamp) {
...
export function projectStatement(userId, project, timestamp) {
...
export function labelStatement(userId, label, timestamp) {
...
export function stateSuccessStatement(userId, response, timestamp, isFullSync, syncStartedAt) {
