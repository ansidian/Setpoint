...
describe("actual.ts sendBill compatibility outcomes", () => {
  beforeAll(async () => {
    const migrations = [
      ...
      "062_financial_events.sql", "071_financial_event_readiness.sql", "068_financial_candidate_dismissal.sql", "063_financial_activity.sql", "064_financial_corrections.sql",
    ];
