...
export const EMPTY_ACTUAL_METADATA = {
  accounts: [],
  payees: [],
  payeeMap: {},
  categories: [],
...
export function metadataWithPayeeMap(metadata = {}) {
...
export function hasActualMetadataRows(metadata = {}) {
  return Boolean(
...
export async function loadActualMetadataForProjection(userId, {
  refreshLocal = true,
...
export function upsertMetadataProjectionQuery(userId, metadata, timestamp) {
  return {
