...
// drive that global:
//
//   1. the lightweight bill-write path  (actual-lightweight-writes.js)
//   2. the local-metadata refresh/sync path (actual-local-metadata.js)
//
...
export function withActualClockLock(fn) {
